...
//#define LOWER LT(L_LOWER, KC_BSLS)
#define LOWER   MO(L_LO)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_QW] = LAYOUT( \
    ...
    XXXXXXX, RAISE,   KC_GRV,  KC_LGUI,          KC_LCTL, KC_SPC,  KC_LSFT,      KC_RSFT, KC_ENT,  KC_RCTL,          KC_MINS, KC_QUOT, LOWER,   XXXXXXX  \
  ),

  [L_UP] = LAYOUT(
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,                        _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,                        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RESET,                          _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_EQL,  _______, \
