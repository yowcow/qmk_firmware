...
#define RAISE   MO(L_UP)
#define LOWER   LT(L_LO, KC_BSLS)
#define SPACE   KC_SPC
#define ENTER   RALT_T(KC_ENT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_QW] = LAYOUT( \
    ...
    XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    SPACE,                          ENTER,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, XXXXXXX, \
    XXXXXXX, RAISE,   KC_GESC, KC_LGUI,          KC_LCTL, SPACE,   KC_LSFT,      KC_RSFT, ENTER,   KC_RCTL,          KC_RGUI, KC_QUOT, LOWER,   XXXXXXX  \
  ),
  ...
  [L_UP] = LAYOUT( \
    ...
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,                        _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_EQL,  _______, \
