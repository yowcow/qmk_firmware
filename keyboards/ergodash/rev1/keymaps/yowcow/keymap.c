...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_QW] = LAYOUT( \
    ...
    XXXXXXX, KC_ESC,  KC_GRV , KC_LGUI,          KC_LCTL, KC_SPC , KC_LSFT,      KC_RSFT, KC_ENT , FUNCT,            KC_MINS, KC_QUOT, KC_BSLS, XXXXXXX  \
  ),

  [L_FN] = LAYOUT( \
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, _______, _______, \
    _______, KC_EXLM, KC_AT  , KC_UP  , KC_DLR , KC_PERC, _______,                        _______, KC_PGUP, KC_7   , KC_8   , KC_9   , KC_BSPC, _______, \
    _______, KC_LPRN, KC_LEFT, KC_DOWN, KC_RGHT, KC_RPRN, KC_CIRC,                        KC_AMPR, KC_PGDN, KC_4   , KC_5   , KC_6   , KC_RALT, _______, \
    _______, KC_LBRC, KC_RBRC, KC_HASH, KC_LCBR, KC_RCBR, IME_TGL,                        _______, KC_ASTR, KC_1   , KC_2   , KC_3   , KC_PPLS, _______, \
    _______, RAISE  , _______, _______,          _______, IME_TGL, _______,      _______, _______, _______,          KC_PDOT, KC_0   , KC_PEQL, _______  \
  ),
