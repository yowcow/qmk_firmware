...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_QWERTY] = LAYOUT( \
    ...
    KC_LALT, XXXXXXX, XXXXXXX,     KC_LALT,      KC_LCTL, KC_SPC , KC_LSFT,      KC_RSFT, KC_ENT , KC_RCTL,      KC_RALT,     KC_PGUP, KC_PGDN, KC_RALT  \
  ),
  ...
  [L_FUNCT] = LAYOUT(
    ...
    _______, KC_BRID, KC_BRIU, XXXXXXX, XXXXXXX, XXXXXXX, _______,                        _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, _______, \
