...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_QWERTY] = LAYOUT( \
    ...
    FNS_L,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_TAB ,                        KC_BSPC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_EQL,  \
    ...
    KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX,          KC_LCTL, KC_SPC , KC_LSFT,      KC_RSFT, KC_ENT , KC_RCTL,          KC_PGUP, KC_PGDN, XXXXXXX, KC_RALT  \
  ),
