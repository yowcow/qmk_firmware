...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    KC_LBRC, KC_RBRC, KC_HASH, KC_LCBR, KC_RCBR, KC_CIRC, KC_AMPR, KC_ASTR, KC_1,    KC_2,    KC_3,    KC_0   ,
    MO(_LW), _______, _______, _______, _______, _______, _______, _______, _______, KC_DOT,  KC_DOT,  KC_GRV ),
