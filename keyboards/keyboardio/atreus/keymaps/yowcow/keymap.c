...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_ESC,  KC_LALT, KC_LGUI, KC_LCTL, KC_SPC,  KC_LSFT, KC_RCTL, KC_ENT,  MO(_RS), KC_MINS, KC_GRV , KC_BSLS ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    KC_LBRC, KC_RBRC, KC_HASH, KC_LCBR, KC_RCBR, KC_CIRC, KC_AMPR, KC_ASTR, KC_1,    KC_2,    KC_3,    KC_QUOT,
    MO(_LW), _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_0,    _______),

  [_LW] = LAYOUT( /* [> LOWER <] */
    KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP,                   KC_UP,   KC_F7,   KC_F8,   KC_F9,   KC_F10  ,
    XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,                   KC_DOWN, KC_F4,   KC_F5,   KC_F6,   KC_F11  ,
    XXXXXXX, KC_VOLD, KC_VOLU, KC_BRID, KC_BRIU, RESET,   KC_DEL , XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F12  ,
